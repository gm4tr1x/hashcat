...
static void AES128_ExpandKey (u32 *userkey, u32 *rek, __L u32 s_te0[256], __L u32 s_te1[256], __L u32 s_te2[256], __L u32 s_te3[256], __L u32 s_te4[256])
{
  rek[0] = userkey[0];
  rek[1] = userkey[1];
  rek[2] = userkey[2];
...
static void AES128_InvertKey (u32 *rdk, __L u32 s_td0[256], __L u32 s_td1[256], __L u32 s_td2[256], __L u32 s_td3[256], __L u32 s_td4[256], __L u32 s_te0[256], __L u32 s_te1[256], __L u32 s_te2[256], __L u32 s_te3[256], __L u32 s_te4[256])
{
...
static void AES128_encrypt (const u32 *in, u32 *out, const u32 *rek, __L u32 s_te0[256], __L u32 s_te1[256], __L u32 s_te2[256], __L u32 s_te3[256], __L u32 s_te4[256])
{
  u32 s0 = in[0] ^ rek[0];
  u32 s1 = in[1] ^ rek[1];
  u32 s2 = in[2] ^ rek[2];
...
static void AES128_decrypt (const u32 *in, u32 *out, const u32 *rdk, __L u32 s_td0[256], __L u32 s_td1[256], __L u32 s_td2[256], __L u32 s_td3[256], __L u32 s_td4[256])
{
  u32 s0 = in[0] ^ rdk[0];
  u32 s1 = in[1] ^ rdk[1];
  u32 s2 = in[2] ^ rdk[2];
...
static void AES256_ExpandKey (u32 *userkey, u32 *rek, __L u32 s_te0[256], __L u32 s_te1[256], __L u32 s_te2[256], __L u32 s_te3[256], __L u32 s_te4[256])
{
  rek[0] = userkey[0];
  rek[1] = userkey[1];
  rek[2] = userkey[2];
...
static void AES256_InvertKey (u32 *rdk, __L u32 s_td0[256], __L u32 s_td1[256], __L u32 s_td2[256], __L u32 s_td3[256], __L u32 s_td4[256], __L u32 s_te0[256], __L u32 s_te1[256], __L u32 s_te2[256], __L u32 s_te3[256], __L u32 s_te4[256])
{
...
static void AES256_decrypt (const u32 *in, u32 *out, const u32 *rdk, __L u32 s_td0[256], __L u32 s_td1[256], __L u32 s_td2[256], __L u32 s_td3[256], __L u32 s_td4[256])
{
  u32 s0 = in[0] ^ rdk[0];
  u32 s1 = in[1] ^ rdk[1];
  u32 s2 = in[2] ^ rdk[2];
...
static void AES256_encrypt (const u32 *in, u32 *out, const u32 *rek, __L u32 s_te0[256], __L u32 s_te1[256], __L u32 s_te2[256], __L u32 s_te3[256], __L u32 s_te4[256])
{
  u32 s0 = in[0] ^ rek[0];
  u32 s1 = in[1] ^ rek[1];
  u32 s2 = in[2] ^ rek[2];
